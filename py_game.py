...
def game_starter(weapons, random_enemy):
    ...
    print_pause(
        "Rumor has it that a " + random_enemy + " is somewhere around here, and has been terrifying the nearby village.")
...
def house(weapons, random_enemy):
    ...
    print_pause(
        "You are about to knock when the door opens and out steps a " + random_enemy + ".")
...
def has_wand(random_enemy):
    print_pause("As the " + random_enemy + " moves to cast a spell, "
                "you unsheath your new sword.")
    print_pause(
        "The Want of Ogoroth shines brightly in your hand as you brace yourself for the attack.")
    print_pause("But the " + random_enemy +
                "takes one look at your shiny new wand and runs away!")
    print_pause("You have rid the town of the " +
                random_enemy + ". You are victorious!")
    ...
    while True:
        ...
        if user_choice == "1":
            if "wand" in weapons:
                ...
                print_pause(
                    "but your rusty olg magic wand is no match for the " + random_enemy + ".")
